...
void RenderScene() {
	...
	{
		GLfloat sunLightPosition[] = {1.0f, 1.0f, 2.0f, 0.0f};
		GLfloat sunLightAmbient[] = {0.5f, 0.5f, 0.5f, 1.0f};
		GLfloat sunLightDiffuse[] = {0.5f, 0.5f, 0.5f, 1.0f};
	...
	{
		GLfloat triangleMatAmbient[] = {0.4f, 0.4f, 0.4f, 1.0f};
		GLfloat triangleMatDiffuse[] = {0.4f, 0.4f, 0.4f, 1.0f};
		GLfloat triangleMatSpecular[] = {0.8f, 0.8f, 0.8f, 0.8f};
		GLfloat triangleMatEmission[] = {0.1f, 0.1f, 0.3f, 1.0f};
		GLfloat triangleMatShininess = 120.0f;
...
void MyInit() {
	ifstream inFile("BumpMap_Huge.pgm");

	string PGM_TYPE;
	inFile >> PGM_TYPE;

	int PGM_X, PGM_Y, PGM_MAX;
	inFile >> PGM_X >> PGM_Y >> PGM_MAX;
