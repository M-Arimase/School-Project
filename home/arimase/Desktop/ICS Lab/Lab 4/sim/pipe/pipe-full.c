...
int gen_f_predPC()
{
    return ((((if_id_next->icode) == (I_CALL)) | (((if_id_next->icode) == 
            (I_JMP)) & (((if_id_next->ifun) == 0) | ((if_id_next->valc) < 
              (if_id_next->valp))))) ? (if_id_next->valc) : 
      (if_id_next->valp));
}
...
int gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVL) || (id_ex_curr->icode) == 
        ...
        (I_MRMOVL) || (id_ex_curr->icode) == (I_JMP) || (id_ex_curr->icode)
         == (I_IADDL)) ? (id_ex_curr->valc) : ((id_ex_curr->icode) == 
        (I_CALL) || (id_ex_curr->icode) == (I_PUSHL)) ? -4 : (
...
int gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
        ...
        (I_RRMOVL) || (id_ex_curr->icode) == (I_IRMOVL) || 
        (id_ex_curr->icode) == (I_JMP)) ? 0 : 0);
}
...
int gen_D_bubble()
{
    return (((((((id_ex_curr->icode) == (I_JMP)) & ((id_ex_curr->ifun) != 0)
          ...
          (ex_mem_next->takebranch)) | (((((id_ex_curr->icode) == (I_JMP))
               & ((id_ex_curr->ifun) != 0)) & ((ex_mem_next->vale) >= 
